...
const TrainingLogos = (props) => {
    ...
    return (
        <>
            ...
            <Box pt={props.padding} sx={{ pb: isMobile ? '13rem' : '11rem', borderTop : isMobile ? '1px solid #f8f8f8':'none' }}>

                <Box px={isMobile ? 2.5 :6}>
                    <Typography sx={{ fontFamily: 'aeonik-reg', color: '#bebebe', fontSize:isMobile ? '1rem' : '1.3rem' }}>THEY USE WEBFLOW</Typography>
                    <Divider sx={{ mt: isMobile ? 2 : 2.5, fontFamily: 'aeonik-reg', bgcolor: '#bebebe', height: isMobile ? 1 : 1.5 }} />
                </Box>

                <StyledBox sx={{ px: isMobile ? 2 : 7, position: 'relative', display: 'flex', flexWrap: 'wrap', gap: isMobile ? 4 : 15, mt: isMobile ? '1rem' : '6rem', justifyContent: 'center', }}>
                ...
                <Box px={2.5} sx={{display:isMobile ? 'normal' : 'none'}}>
                <Divider sx={{ mt:2, fontFamily: 'aeonik-reg', bgcolor: '#bebebe',}} />
                </Box>
            </Box>
