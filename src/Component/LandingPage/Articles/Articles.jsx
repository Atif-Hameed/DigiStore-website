...
const Articles = () => {
    ...
    return (
        <>
            <Grid container px={6} spacing={4}>
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(1) }} onMouseLeave={() => { handleLeave(1) }} >
                        {isHovered[1] ? (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt1F} alt="" />
                            </>
                        ) : (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt1M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>T-SHIRT WEBFLOW BUILDER</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>34,90 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(2) }} onMouseLeave={() => { handleLeave(2) }} >
                        {isHovered[2] ? (
                            ...
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt2M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>T-SHIRT DESIGNER FIGMA</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>34,90 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(3) }} onMouseLeave={() => { handleLeave(3) }} >
                        {isHovered[3] ? (
                            <>
                                <img width={'350rem'} src={shirt3F} alt="" />
                            </>
                        ) : (
                            <>
                                <img width={'350rem'} src={shirt3M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>T-SHIRT 19 AVRIL</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>490 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(4) }} onMouseLeave={() => { handleLeave(4) }} >
                        ...
                        {isHovered[4] ? (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt4F} alt="" />
                            </>
                        ) : (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt4M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>GREEN AURA CAP</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}> 35 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(5) }} onMouseLeave={() => { handleLeave(5) }} >
                        ...
                        {isHovered[5] ? (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt5F} alt="" />
                            </>
                        ) : (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt5M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>AURA FIGMA DESIGNER CAP</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}> 35 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(6) }} onMouseLeave={() => { handleLeave(6) }} >
                        ...
                        {isHovered[6] ? (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt6F} alt="" />
                            </>
                        ) : (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt6M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>STICKERS BUILDER</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}> 8 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} onMouseEnter={() => { handleHover(7) }} onMouseLeave={() => { handleLeave(7) }} >
                        ...
                        {isHovered[7] ? (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt7F} alt="" />
                            </>
                        ) : (
                            <>
                                <img src={svgPic} width={'350rem'} style={{ position: 'absolute' }} alt="" />
                                <img width={'350rem'} src={shirt7M} alt="" />
                            </>
                        )}
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>STICKERS AURA</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}> 8 €</Typography>
                    </Box>
                </Grid>
                ...
                <Grid item sm={3} xs={12}>
                    <Box position={'relative'} sx={{ cursor: 'pointer' }} width={'fit-content'} >
                        ...
                        <img width={'350rem'} src={cupM} alt="" />
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}>DIGIDOP MUG</Typography>
                        <Typography fontFamily={'aeonik-reg'} fontSize={'large'}> 20 €</Typography>
                    </Box>
                </Grid>
