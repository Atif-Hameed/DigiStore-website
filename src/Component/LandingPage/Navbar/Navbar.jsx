    ...
    return (
        <>
            <Box sx={{ display: 'flex', justifyContent: 'end' }}>
                <AppBar elevation={0} className='navbar' sx={{ width: isMobile ? '100%' : isTablet ? '46%' : '76.1%', backgroundColor: '#fff', border: '3px solid #fdd33c', borderLeft: isMobile ? 'none' : 'normal', borderBottom:isMobile ? 'none' : 'normal', borderRight: 'none', borderTop: 'none', top: isMobile ? '36.3px' : '44.5px' }} position={"fixed"}  >
